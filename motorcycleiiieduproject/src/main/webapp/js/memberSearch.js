				...
				success: function (response) {
					...
					for (let sobj in response) {
						...
						$("#allord").append(
							...
							"</td>" +
							"<td>" +
							"<h6>取車  <span class='ml-5' id='brStore'>" + response[sobj].pickupStore + "</span><span class='ml-1' id='brTime'>2018/03/22 11:00</span></h6>" +
							"<h6>還車  <span class='ml-5' id='rtStore'>" + response[sobj].dropoffStore + "</span><span class='ml-1' id='rtTime'>2018/03/22 14:00</span></h6>" +
